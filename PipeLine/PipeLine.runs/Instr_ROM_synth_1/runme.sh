...
HD_PWD='D:/Dragoncore/PipeLine/PipeLine.runs/Instr_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Instr_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Instr_ROM.tcl
